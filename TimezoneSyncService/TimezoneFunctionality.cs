...
namespace SSTimezone
{
    class TimezoneFunctionality
    {
        ...
        [DllImport("kernel32.dll", CharSet = CharSet.Auto)]
        private static extern bool SetDynamicTimeZoneInformation([In] ref TimeZoneInformation lpTimeZoneInformation);
        ...
        public static void SetTimeZone(TimeZoneInformation tzi)
        {
            ...
            //SetDynamicTimeZoneInformation(ref tzi);
        }
        ...
        /// </summary>
        /// <param name="tzi">Struct containing the time-zone parameters to set.</param>
        public static void SetDynamicTimeZone(TimeZoneInformation tzi)
        {
            // set local system timezone
            //SetTimeZoneInformation(ref tzi);
            SetDynamicTimeZoneInformation(ref tzi);
